...
<div id="main">
  ...
  <form action="updateRole.form" method="post" class="main_form">
      ...
      <div class="input_info_scroll">
        <ul>
          <c:forEach items="${modules}" var="module">
            <li>
              <input
                 <c:forEach items="${role.modules}" var="r_module">
                   <c:if test="${module.module_id==r_module.module_id}">checked </c:if>
                 </c:forEach>
                 id="chbox_module_${module.name}" type="checkbox" name="module_ids" value="${module.module_id}"/>
